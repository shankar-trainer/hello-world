...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet,RouterLink, CommonModule, Counterapp1Component, Parent1Component, Parent2Component, BookComponent, CustomerComponent, 
    ReactiveFormComponent, ReactiveFormComponent1, CrudComponent],
