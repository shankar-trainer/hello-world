...
class UserForm extends Component {
    ...
    name_change = (event) => {
        if (event.target.value == '')
            ...
            this.setState({ name_error: 'name must of minimum 5 charcater' })
            ...
            <div className="border border-primary p-5 m-5 w-50 bg-info">
                <form>
                    <div className="form-group">
                        ...
                        <input className="form-control" onClick={this.id_change}></input>
                        <span>{this.state.id_error}</span>
                    </div>

                    <div className="form-group">
                        <label>Enter Name</label>
                        <input className="form-control" onClick={this.name_change}></input>
