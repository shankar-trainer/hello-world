...
public class Main {
    public static void main(String[] args) {
        ...
        cashPayment.setPaymentId(1);
        cashPayment.setPaymentAmt(10000);
        cashPayment.setPaymentUserName("amit kumar");

        CreditCardPayment cardPayment = new CreditCardPayment();

        cardPayment.setPaymentId(2);
        cardPayment.setPaymentAmt(20000);
