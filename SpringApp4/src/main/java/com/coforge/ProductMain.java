...
public class ProductMain {
	...
	public static void main(String[] args) {
		...
		Product updateProduct = dao.updateProduct(prd[2], new Product(3, "pizza", 600));
		if (updateProduct != null) {
			System.out.println("product update " + updateProduct);
		}
		
		System.out.println("\nremove operation");
		Product removeProduct = dao.removeProduct(prd[0]);
		if (removeProduct != null) {
			System.out.println("product removed " + updateProduct);
		}
