...
public class DoctorController {
    ...
    public Mono<Doctor> addDoctor(@RequestBody Doctor doctor) {
    	...
    	System.out.println("addDoctor controller doctor object "+doctor );
    	//Doctor doctor2=new Doctor(doctor.getName(), doctor.getAge());
    	return service.addDoctor(doctor);
        //return service.addDoctor(Doctor.builder().Name(doctor.getName()).Age(doctor.getAge()).build());
    }
/*
