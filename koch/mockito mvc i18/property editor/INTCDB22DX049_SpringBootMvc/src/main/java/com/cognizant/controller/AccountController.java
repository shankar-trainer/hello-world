...
import com.cognizant.error.AccountException;
...
public class AccountController {
	...
	public String accountResultPage(@RequestParam("actId") int id,@RequestParam("actName") String name,@RequestParam("actSalary") float salary,@RequestParam("actCreationDate") Date date ,ModelMap map)  throws AccountException{
		if(id<=0)
