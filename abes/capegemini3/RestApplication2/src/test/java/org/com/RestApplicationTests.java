...
class RestApplicationTests {
	...
	public void searchProductRecord() {
		//Product product = restTemplate.getForObject("http://localhost:9090/prd/getProduct/1003", Product.class);
		ResponseEntity<Product> product1 = restTemplate.getForEntity("http://localhost:9090/prd/getProduct/1003", Product.class);
	...
	public void deleteProductRecord() {
		...
		//restTemplate.delete("http://localhost:9090/prd/getProduct/1003", product);
	...
	public void addProductRecord() {
		Product product = new Product();
		//product.setPrdId(1234);
		product.setPrdCost(890);
		product.setPrdName("clock");
		try {
			ResponseEntity<Product> postForEntity = restTemplate.postForEntity("http://localhost:9090/prd/getProduct",
