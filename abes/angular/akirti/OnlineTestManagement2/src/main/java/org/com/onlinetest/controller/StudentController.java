...
import org.com.onlinetest.dao.AnswerDao;
...
import org.com.onlinetest.model.*;
...
public class StudentController {
	...
	public Student addStudent(@RequestBody Student std) {
            System.out.println("student added  "+std);
	...
	public BigDecimal getResult(@RequestBody Test test) {
        ...
        @Autowired
        QuestionDao quesdao2;
          
        @Autowired
        AnswerDao ansdao3;
                
        @PostMapping("/addQuestion")
        public Question addQuestion(@RequestBody Question test){
              return  quesdao2.save(test);
        }
       
        @PostMapping("/addAnswer")
        public Answer addAnswer(@RequestBody Answer test ){
          
           return  ansdao3.save(test);
        }
...
/*        @GetMapping("/AllTest")
	public Test getAllStudent1(BigInteger stdId) {
