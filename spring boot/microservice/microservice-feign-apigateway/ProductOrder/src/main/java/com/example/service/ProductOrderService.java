...
public class ProductOrderService {
    ...
    public ProductOrderService(ProductOrderRepository orderRepository, ProductFeignClient feignClient) {
    ...
    public ResponseEntity<ProductOrder> addProductOrder(ProductOrder order) {
        try{
            ResponseEntity<Product> productResponseEntity = feignClient.searchById(order.getPrdId());
