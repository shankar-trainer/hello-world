...
<body>
	...
	<div
		...
		<s:form action="userAction">
			...
			<s:checkboxlist label="Select Hobbies"
				list="{'Swimming','Reading','Music','Movie','Flowering'}"
				name="hobbies" />
			<br>

			<s:select multiple="" label="Select Cities"
				list="{'Delhi','Noida','Gurgaon','Aagra','Mathura'}" name="city" />
			<br>
