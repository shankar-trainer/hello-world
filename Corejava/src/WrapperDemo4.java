...
public class WrapperDemo4 {
   ...
   String decimal = Integer.toString(67766,10);//base 10
   String hex1 = Integer.toString(67766,16);//base 16
   String binary1 = Integer.toString(67766,2);//base 2
   String oct1 = Integer.toString(67766,8);//base 8
   System.out.println("============");
