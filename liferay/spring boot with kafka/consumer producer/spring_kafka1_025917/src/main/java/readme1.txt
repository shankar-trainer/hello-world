using kafka_2.13-4.3.0

C:\kafka_2.13-4.3.0\bin>windows\kafka-topics.bat --create --topic topic1 --bootstrap-server localhost:9092
C:\kafka_2.13-4.3.0\bin>windows\kafka-topics.bat --list --bootstrap-server localhost:9092
C:\kafka_2.13-4.3.0\bin>start windows\kafka-console-producer.bat --bootstrap-server localhost:9092 --topic  topic1
C:\kafka_2.13-4.3.0\bin>windows\kafka-console-consumer.bat --bootstrap-server localhost:9092 --topic topic1 --from-beginning

:\Users\shank>curl.exe -X POST "http://localhost:8080/send1?msg=HelloKafka77777"

C:\Users\shank>curl.exe -X POST "http://localhost:8080/send/HelloKafka77777"

consumer with group
C:\kafka_2.13-4.3.0\bin>windows\kafka-console-consumer.bat      --bootstrap-server localhost:9092     --topic topic1     --group group1     --from-beginning
not work  without group it works
...
Run Application: Boot up your Spring Boot app.
Send a Test Request: Open Postman, curl, or your browser and hit your endpoint:
